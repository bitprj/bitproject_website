  ...
  return (
    <div>
      ...
      <GraphicTabBottom
        ...
        desc="In our 10-week boot camp, build awesome apps with Serverless functions, JavaScript, and APIs. From IoT heartbeat monitors to face mask detectors, you can build anything with Serverless!"
        cta1="Apply Now"
      ...
      <Textblock
        ...
        para2="The Serverless Camp is an 10-week interactive coding bootcamp designed to help you gain real-world technical skills through project-based learning and build awesome professional connections. We will be offering two programs this summer: the Mentorship Program and the Global Student Community."
      />
